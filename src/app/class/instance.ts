...
export class InstanceLayer {
  ...
  public setAttributeEntityInstance(
    attributeEntityInstance: AttributeEntityInstance
  ) {
  ...
  public setUncertainEntityInstances(
    uncertainEntityInstances: Array<UncertainEntityInstance>
  ) {
  ...
  public setCyberServiceInstances(
    cyberServiceInstances: Array<CyberServiceInstance>
  ) {
