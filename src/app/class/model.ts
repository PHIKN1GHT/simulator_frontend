...
export class ModelLayer {
  ...
  public setUncertainEntityTypes(
    uncertainEntityTypes: Array<UncertainEntityType>
  ) {
...
export class DeviceType extends EntityType {
  ...
  stateSyncValueEffects: Array<StateSyncValueEffect> =
    new Array<StateSyncValueEffect>(); //各状态信息
  public getStateSyncValueEffects() {
    return this.stateSyncValueEffects;
  }

  public setStateSyncValueEffects(
    stateSyncValueEffects: Array<StateSyncValueEffect>
  ) {
