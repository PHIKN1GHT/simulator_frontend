...
import {
  BestScenarioOutput,
  InteractiveLayerAndRules,
} from '../class/output-style';
import {
  BestScenarioGenerateInput,
  ModelInstanceLayerAndRuleStrs,
...
export class ModelGenerateService {
  ...
  ): Observable<InteractiveLayerAndRules> {
  ...
  generateSingleScenario(
    ...
    modelLayer: ModelLayer,
    instanceLayer: InstanceLayer,
    interactiveInstance: InstanceLayer,
    rules: Array<Rule>,
